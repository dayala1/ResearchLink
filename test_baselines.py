...
for i in range(10):
    print("Iteration: ", i)
    model = RotatE(triples_factory=training_factory, embedding_dim=embedding_dim, random_seed=i)
...
print(f"Results for model {model.__class__.__name__} with embedding dimension {embedding_dim}")
print(metrics)
